...
export default function Menu() {
    return (
        <div className='  max-w-[1600px] min-w-[500px] flex flex-wrap justify-center items-center m-10 mt-40  border-b border-gray-300'>            <div className='w-1/3 min-w-100 ml-10 '>
